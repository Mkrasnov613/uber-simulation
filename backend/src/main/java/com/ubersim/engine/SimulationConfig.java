...
public class SimulationConfig {
    ...
    public static SimulationConfig defaults() {
        return SimulationConfig.builder().driverCount(30).passengerCount(15).maxPassengerWaitTicks(20).driverSpeedKmPerTick(0.1).quotaMode("RIDES").quotaTarget(5.0).maxTicks(100).build();
    }
}